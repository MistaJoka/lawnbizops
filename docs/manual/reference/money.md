...
| Accepted           | **Create job** card (date → **Create job**; carries the catalog service when the first line matches; inline **+ Add property** if none) · **Create recurring schedule** (disabled with the same add-property affordance when property-less) · **Deposit** card (25% / 50% / custom → flagged deposit invoice) · **Convert to invoice** (one-to-one guarded; deducts the deposit) |
...
[G-01](../../ops-manual-findings-2026-07-31.md#g-01) (no online payment) · [G-09](../../ops-manual-findings-2026-07-31.md#g-09) (PDF needs synced number) · [G-12](../../ops-manual-findings-2026-07-31.md#g-12) (no discounts/late fees/statements/credits) · [G-20](../../ops-manual-findings-2026-07-31.md#g-20) (token-only approval) · [G-21](../../ops-manual-findings-2026-07-31.md#g-21) (no trend/by-service reports) · _G-05 and G-06 fixed 2026-07-31_
